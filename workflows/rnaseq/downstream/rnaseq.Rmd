...
knitr::opts_chunk$set(
    ...
    cache.extra_file_dep_2 = file.info('../data/rnaseq_samples/*/*.kallisto/abundance.tsv')$mtime
)
```
...
vsd.txi <- varianceStabilizingTransformation(dds.salmon.txi, blind=TRUE)
```
...
vsd.txi <- varianceStabilizingTransformation(dds.kallisto.txi, blind=TRUE)
```
