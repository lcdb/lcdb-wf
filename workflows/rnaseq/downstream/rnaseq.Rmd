...
```{asis, eval=config$toggle$functional_enrichment}
...
```{r functional_enrichment_prep, cache=TRUE, config=config$annotation$keytype, eval=config$toggle$functional_enrichment}
