...
#   Change the letter prefix of the contrast to adjust order of appearance in the html
#   Each contrast will appear in the res.list without the prefix "contr_[A-z]_".
#   Make a separate chunk for each contrast.
contr_a_main <- list(
...
```{r results2, dependson='dds_list', cache=TRUE}
