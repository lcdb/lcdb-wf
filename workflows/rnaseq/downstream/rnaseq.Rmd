...
## Other diagnostics {.tabset}


```{r, results='asis', cache=TRUE, dependson='dds_list'}
for (name in names(dds_list)){
  ...
  mdcat("#### Sparsity plot")
  mdcat("This plot can be used to see if the majority of genes with high counts are",
    "coming from individual (or a small number of) samples.")
